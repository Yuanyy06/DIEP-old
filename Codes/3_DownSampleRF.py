...
for i in list(range(200)):
    ...
    # model parameters
    RF = RandomForestClassifier(random_state=10, oob_score=True, n_jobs=10)
    RF.fit(X, y)
    ...
    # prediction, and calculate feature importance
    if i == 0:
    ...
    # calculate feature contribution by treeinterpreter
